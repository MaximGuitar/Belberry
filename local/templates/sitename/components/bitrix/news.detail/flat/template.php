...
<div class="click-counter" 
     ...
     data-iblock-id="1"
     data-ajax-url="/ajax/add_point.php">
     
    <p>Кликов: <span class="js-counter-value"><?=$arResult['PROPERTIES']['AJAX_CLICK']['VALUE'] ?: 0?></span></p>
    <button class="js-increment-button">+1</button>
</div>